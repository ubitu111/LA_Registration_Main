...
public class Volunteer_old_java {
    ...
    public Volunteer_old_java(int uniqueId, int index, String name, String surname, String callSign, String phoneNumber, String isSent,
    ...
    @Ignore
    public Volunteer_old_java(int index, String name, String surname, String callSign, String phoneNumber, String isSent,
                     String carMark, String carModel, String carRegistrationNumber, String carColor, String isAddedToFox) {
        this.index = index;
        this.name = name;
        this.surname = surname;
